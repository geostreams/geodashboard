export const gd3 = {
    ...
    "specific-conductivity-uscm": "Specific Conductivity (USCM)",
    ...
    "filter_total_chlordane": "Filtered Total Chlordane (pg/m^3)",
    "filter_total_ddts": "Filtered Total DDTs (pg/m^3)",
    "filter_total_endos": "Filtered Total Endos (pg/m^3)",
    "filter_total_pahs": "Filtered Total PAHs (pg/m^3)",
    "filter_total_pests": "Filtered Total PESTs (pg/m^3)",
    "precip_total_chlordane": "Precipitation Total Chlordane (pg/L)",
    "precip_total_ddts": "Precipitation Total DDTs (pg/L)",
    "precip_total_endos": "Precipitation Total Endos (pg/m^3)",
    "precip_total_pahs": "Precipitation Total PAHs (pg/L)",
    "precip_total_pests": "Precipitation Total PESTs (pg/L)",
    "vapor_suite_pcbs": "Vapor Total PCBs (pg/m^3)",
    "vapor_total_chlordane": "Vapor Total Chlordane (pg/m^3)",
    "vapor_total_ddts": "Vapor Total DDTs (pg/m^3)",
