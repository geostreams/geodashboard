...
D3Line._drawPoints = function (el, state) {
    const {width, height, sources, displayLines, startAtZero, binType, tooltipClass, overlayClass, truncate_title_at = 30, sources_placement = 'center'} = state;
    ...
    if (title.length > truncate_title_at) {
        parsed_title = title.substring(0, truncate_title_at) + "..."
    }
