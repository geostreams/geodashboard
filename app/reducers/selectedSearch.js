...
import {ADD_SEARCH_DATASOURCE, ADD_SEARCH_PARAMETER, ADD_SEARCH_LOCATION, UPDATE_AVAILABLE_FILTERS,
    ADD_START_DATE, ADD_END_DATE, RECEIVE_SENSORS } from '../actions'
...
type SelectedSearchAction = {| type:string, sensors:Sensors, data_sources: DatasourceParameter,
...
const defaultState = {  data_sources: {selected: [], available: []},
                        ...
                        dates: {selected: {start: null, end: null},
