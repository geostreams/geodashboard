...
import __old_About from './containers/About';
import __old_Home from './containers/Home';

const routes = {
    '/': { exact: true, component: hocs.withLayout(GLMLayout, __old_Home, { hasFooter: true }) },
    '/about': { exact: true, component: hocs.withLayout(GLMLayout, __old_About, { hasFooter: true }) },
