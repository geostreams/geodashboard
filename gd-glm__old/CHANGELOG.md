...
### Changed
- Update displayed information in Sources and Errors
  [GEOD-1292](https://opensource.ncsa.illinois.edu/jira/browse/GEOD-1292)
- Welcome Page Carousel Changes
...
- Add option for Explore Page Data Sources to Start Closed
  [GEOD-1186](https://opensource.ncsa.illinois.edu/jira/browse/GEOD-1186)
- Added home and about page for Great Lakes Monitoring
  [GEOD-1159](https://opensource.ncsa.illinois.edu/jira/browse/GEOD-1159)
- Merged develop into GLM branch
  [GEOD-1175](https://opensource.ncsa.illinois.edu/jira/browse/GEOD-1175)
- Added Handling for Italics in Parameter Names
  [GEOD-897](https://opensource.ncsa.illinois.edu/jira/browse/GEOD-897)
- Version number to the home page and about page.
...
- Added Phosphorus to the Trends Parameters, and updated the Trends Info Box Text
  [GEOD-1192](https://opensource.ncsa.illinois.edu/jira/browse/GEOD-1192)
- Move Popup slightly when opening, whether from map click or accordion selection
  [GEOD-1219](https://opensource.ncsa.illinois.edu/jira/browse/GEOD-1219)
...
### Changed
- Updated configuration file to be GLM specific
  [GEOD-1044](https://opensource.ncsa.illinois.edu/jira/browse/GEOD-1044)
