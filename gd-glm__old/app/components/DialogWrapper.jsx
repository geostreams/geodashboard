    ...
    render() {
        ...
        if (this.props.body !== undefined) {
            if (this.props.body.description !== undefined) {
                if (this.props.body_image != undefined){
                    body_text = <div>
                        {this.props.body.description}
                        <br/>
                        <img src={this.props.body_image}/>
                    </div>;
                } else {
                    if(this.props.body.description.indexOf("</") > 0 ) {
                        body_text = <div dangerouslySetInnerHTML={{__html: this.props.body.description}} />
                    } else {
